    ...
    <div className="container lg:pb-[116px]">
      ...
      <header className="text-center md:text-left">
        ...
        <p className="text-xl md:w-2/3">
          Powerful, tailor made approach to each and every challenge. We’ll help you make your goals and ideas a reality.
        </p>
      </header>
      ...
      <div className="mt-16 lg:flex lg:flex-row-reverse">
        ...
        <div className="relative lg:w-3/5  h-[528px] lg:ml-[10%] mt-12 lg:mt-0">
          {images.map((src, index) => {
            ...
            const rotation = isSelected ? "rotate-0" : index === 1 ? "rotate-[15deg]" : index === 2 ? "rotate-[-15deg]" : "rotate-[30deg]";
            const opacity = isSelected ? "opacity-100" : "opacity-40";
            const zIndex = isSelected ? "z-30" : isBehind ? "z-10" : "z-20";
            const topOffset = isSelected ? "top-0 left-0" : index === 1 ? "top-4 left-4" : "top-8 left-8";
            ...
            >
              <div>
                ...
                <div className="flex items-center mt-3 space-x-2">
                  <Link href="/solutions" className="text-brand-saturated font-semibold">
                    Learn More
                  </Link>
