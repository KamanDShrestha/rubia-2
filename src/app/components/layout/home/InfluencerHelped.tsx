      ...
      <div className='container md:flex justify-between items-center'>
        <div className='hidden lg:block w-1/2  relative'>
          ...
          <div className='mt-2.5 flex justify-center space-x-2.5 items-center'>
            <div className='w-[112px] relative h-[140px]'>
              <div
            ...
            <div className='w-[112px] relative h-[140px]'>
              ...
              ></div>
              <div className='absolute bottom-0 group-hover:translate-x-[5%] group-hover:translate-y-[230%] transition-transform duration-300 ease-out'>
                <SubscriberBadge
